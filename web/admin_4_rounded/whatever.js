        ...
        init: function () {
            ...
            if (jQuery().fullCalendar) {
                ...
                $("#external-events div.external-event").each(function () {
                    ...
                    eventDragStop: function(event_box,jsEvent) {
                        alert('Coordinates: ' + jsEvent.pageX + ',' + jsEvent.pageY);
                        if( (0 <= event_box.pageX) & (event_box.pageX <= 0) & (19 <= event_box.pageY) & (event_box.pageY <= 19)){
                            alert('delete: '+ event.id);
                            $("#claendar").fullCalendar('removeEvents', events.id);
                        }
                    },
